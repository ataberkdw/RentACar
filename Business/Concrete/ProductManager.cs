...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        {
            IResult result = BusinessRules.Run(CheckIfProductCountOfCategoryCorrect(product.CategoryId),CheckIfProducTNameExists(product.ProductName), CheckIfCategoryLimitExceded(15));
        ...
        private IResult CheckIfCategoryLimitExceded(int categoryLimit)
        {
